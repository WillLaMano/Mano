...
class FacebookAuthTest < ActiveSupport::TestCase
  ...
  test "Access Token should be valid" do
    ...
    VCR.use_cassette('facebook/test_access_token') do
      ...
      expires_range = fb_auth.expires_at.to_i-10..fb_auth.expires_at.to_i+10
      assert_include expires_range ,token.expires_at,  "Access Token Expiration should be from DB"
    end
  end
  ...
  test "Getting Statuses no limit" do
    ...
    VCR.use_cassette('facebook/get_statuses_no_limit') do
  ...
  test "Getting Statuses limit 5" do
    ...
    VCR.use_cassette('facebook/get_statuses_limit_5') do
  ...
  test "Get Profile Picture" do
    ...
    VCR.use_cassette("facebook/get_profile_picture") do
