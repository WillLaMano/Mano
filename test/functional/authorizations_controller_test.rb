...
class AuthorizationsControllerTest < ActionController::TestCase
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post :create, authorization: { auth_token: @authorization.auth_token, auth_type: @authorization.auth_type, user_id: @authorization.user_id }
    end
  ...
  test "should update authorization" do
    put :update, id: @authorization, authorization: { auth_token: @authorization.auth_token, auth_type: @authorization.auth_type, user_id: @authorization.user_id }
    assert_redirected_to authorization_path(assigns(:authorization))
  end
